...
The [public README](https://github.com/legioncodeinc/vibe-coding-tools#what-ships) lists optional packs. Install the `highlevel` pack only when you need HighLevel API, AI Studio, or workflow-export work, for example. A pack contains its own Stingers and, where applicable, Drones.
